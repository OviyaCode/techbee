...
function AdminList() {
    ...
    const data = [
        ...
        { id: 3, name: "Bob Smith", role: "admin" },
        { id: 4, name: "Alice Jones", role: "user" },
        { id: 5, name: "Tom Lee", role: "editor" },
        { id: 6, name: "Samantha Lee", role: "user" },
        { id: 7, name: "Michael Johnson", role: "admin" },
        { id: 8, name: "Lily Chen", role: "user" },
        { id: 9, name: "David Kim", role: "editor" },
        { id: 10, name: "Emily Wang", role: "admin" }
    ];
            ...
            <div className="col-md-12">
                <div className="card">
                    <div className="card-header">
                        <strong className="card-title">Admin List</strong>
                    </div>
                    <BootstrapTable
                        keyField="id"
                        data={data}
